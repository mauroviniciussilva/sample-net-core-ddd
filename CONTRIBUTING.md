# Contributing to Sample .NET Core DDD
...
## We Use Github Flow
Pull requests are the best way to propose changes to the codebase, as all code changes happen through them (we 
...
We use GitHub issues to track public bugs. Report a bug by opening a new issue! Remember to write bug reports with 
detail, background, and sample code.
